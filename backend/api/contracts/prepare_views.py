...
from backend.contracts.extraction import build_prepare_shadow_candidates
...
def _persist_prepare_extraction_shadow(contract, version, snapshot, draft_text, prepared_terms, created_records, user):
    ...
    for candidate in build_prepare_shadow_candidates(contract, version, run, prepared_terms, draft_text):
        candidate.save()
