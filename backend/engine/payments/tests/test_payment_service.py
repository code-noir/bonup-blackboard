...
class PaymentServiceTests(TestCase):
    ...
    def test_partial_payment(self):
        ...
        result = self.service.process_payment(ob, 50)
    ...
    def test_full_payment_resolves(self):
        ob = create_obligation()
        result = self.service.process_payment(ob, 200)
    ...
    def test_overpayment_caps(self):
        ob = create_obligation()
        self.service.process_payment(ob, 250)
    ...
    def test_negative_payment_fails(self):
        ob = create_obligation()
        result = self.service.process_payment(ob, -10)
